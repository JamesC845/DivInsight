...
```{r}
# use the table and sort functions to see the size of each site group
...
The charts show varying patterns of diversity over time but it is important to know where these changes are taking place
